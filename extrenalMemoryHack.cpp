...
int main() {
    while (true) {
        ...
        ReadProcessMemory(PRocesscs, (PBYTE*)(BaseAdress + 0x121728), NULL, 4, 0);
        WriteProcessMemory(PRocesscs, (PBYTE*)(BaseAdress + 0x121728), &NEW_HEALTH_VALUE, 4, 0);
    }
}
